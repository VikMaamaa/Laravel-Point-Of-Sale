...
<br>
                                <form method="POST"  action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('login') is-invalid @enderror" name="login" type="text" id="login" required="" >
                                        @error('login')
        ...
        <footer class="footer footer-alt">
            2025 - <script>document.write(new Date().getFullYear())</script> &copy; Easy by <a href="" class="text-white-50">Easy Learning</a>
        </footer>
